---
description: Analyze the entire project to understand its architecture, patterns,
  technologies, and data flow, providing a comprehensive overview. Optional arguments
  can provide a specific focus for the analysis.
---
