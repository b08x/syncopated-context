---
description: Design and implement AI data infrastructure — PostgreSQL/pgvector schemas, chunking pipelines, embedding strategies, neuro-symbolic RAG, SFL metadata schemas, or knowledge graphs. Verifies gem APIs (rubysmithing-researcher) → designs and implements (rubysmithing-builder) → quality gate (rubysmithing-auditor).
