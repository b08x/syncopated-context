---
description: End-to-end Ruby diagnosis and fix. Runs Gemba Walk / root cause analysis (rubysmithing-auditor) then applies targeted convention-aligned fixes (rubysmithing-auditor).
...
Dispatch the `rubysmithing-auditor` agent with this context:
