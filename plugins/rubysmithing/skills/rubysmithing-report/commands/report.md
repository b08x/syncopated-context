...
- `$CLAUDE_PLUGIN_ROOT/skills/rubysmithing-report/SKILL.md`
- `$CLAUDE_PLUGIN_ROOT/skills/rubysmithing-report/references/sift-protocol.md` (load immediately — Rubysmith Pragmatist persona)
...
Execute the selected mode's output format per `references/sift-protocol.md`. When suggesting fixes, reference named patterns from `$CLAUDE_PLUGIN_ROOT/skills/rubysmithing-refactor/references/refactor-patterns.md`.
