...
**First action:** Read `$CLAUDE_PLUGIN_ROOT/skills/rubysmithing/references/convention-detection.md` to load the canonical convention cascade, then read `$CLAUDE_PLUGIN_ROOT/skills/rubysmithing-report/references/sift-protocol.md` to load the SIFT V1.0 dimensions.
