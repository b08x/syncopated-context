...
Sub-agents MUST return structured `[AGENT ERROR]` blocks (see `$CLAUDE_PLUGIN_ROOT/skills/plan/references/error-contract.md`) rather than bare failure strings. When you receive one:
